...
REM Repository: projects/anl2026
echo Restoring: projects/anl2026
if exist "projects\anl2026\.git" (
    ...
    git clone "git@github.com:autoneg/anl2026.git" "projects\anl2026"
    if errorlevel 1 (
